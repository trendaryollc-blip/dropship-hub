    ...
    <div className="glass rounded-2xl p-6 relative overflow-hidden">
      ...
      <div className="flex items-center justify-between mb-5 relative">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-muted-foreground">TAM / SAM / SOM analysis</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-5 relative">
        <div className="rounded-xl bg-surface/40 p-4 text-center border border-border/30">
          <p className="text-[10px] text-muted-foreground mb-2 font-medium">TAM</p>
          <p className="text-lg font-display font-bold text-blue-400">${data.marketSize.tam.toLocaleString()}</p>
          <p className="text-[9px] text-muted-foreground mt-1">Total Market</p>
        </div>
        <div className="rounded-xl bg-surface/40 p-4 text-center border border-border/30">
          <p className="text-[10px] text-muted-foreground mb-2 font-medium">SAM</p>
        ...
        <div className="rounded-xl bg-surface/40 p-4 text-center border border-border/30">
          <p className="text-[10px] text-muted-foreground mb-2 font-medium">SOM</p>
      ...
      <div className="grid grid-cols-2 gap-3 mb-5 relative">
        <div className="rounded-xl bg-surface/40 p-4 border border-border/30">
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-[10px] text-muted-foreground font-medium">Growth Rate</p>
          </div>
          <p className="text-lg font-display font-bold text-emerald-400">{data.growthRate.current}%</p>
          <p className="text-[9px] text-muted-foreground mt-1">Projected: {data.growthRate.projected}%</p>
        ...
        <div className="rounded-xl bg-surface/40 p-4 border border-border/30">
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-[10px] text-muted-foreground font-medium">Social Buzz</p>
          </div>
