...
export default function NicheListItem({ niche, index, onSelect }: { niche: NicheData; index: number; onSelect: (id: string) => void }) {
  ...
  return (
    <div
      ...
      className={`glass rounded-xl border border-border p-4 cursor-pointer hover:border-accent/20 transition-all duration-500 group ${isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 text-[10px] text-muted-foreground">
            ...
            <span>{niche.saturation}% saturated</span>
          </div>
        </div>
        <div className="flex items-center gap-3 shrink-0">
          <div className="text-center">
            ...
            <span className="text-[8px] text-muted-foreground">heat</span>
          </div>
          <div className="text-center">
            ...
            <span className="text-[8px] text-muted-foreground">growth</span>
          </div>
