...
function SupplierCard({ supplier, index }: { supplier: SupplierProfile; index: number }) {
          ...
          <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1 flex-wrap">
                ...
                {supplier.source === "cj" && (
                  <span className="text-[9px] px-1.5 py-0.5 rounded-full bg-emerald-400/10 border border-emerald-400/20 text-emerald-400 font-bold">LIVE API</span>
                )}
              </div>
          ...
          <div className="flex items-center gap-3 sm:gap-4 sm:shrink-0">
            ...
            <div className="text-right">
              <div className="flex items-center gap-1 text-amber-400">
                ...
                <span className="font-display text-sm font-bold">{supplier.stats.rating.toFixed(1)}</span>
              </div>
              <p className="text-[9px] text-muted-foreground mt-0.5">{supplier.stats.reviews.toLocaleString()} reviews</p>
            </div>
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      {loading ? (
        ...
        <div className="glass rounded-2xl p-8 text-center">
          ...
          <button onClick={fetchSuppliers} className="text-sm text-accent hover:text-accent/80 flex items-center gap-2 mx-auto">
